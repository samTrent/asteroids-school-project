...
public:
   ...
   Interface()
   {
      initialize(0, 0x0000, "Window", Point(-50, 50), Point(50, -50));
   };
   ...
   int  isSpaceHold() const { return isSpaceHoldDown; };
   ...
   //menu nav
   bool isNavUp()       const { return isNavUpPress;  };
   bool isNavDown()     const { return isNavDownPress;};
   
   static void *p;                   // for client
   static void (*callBack)(const Interface *, void *);
   
   
   //game speed accessors
   int getTheGameSpeed() { return theGameSpeed; };
   void setTheGameSpeed(int theGameSpeed) {this->theGameSpeed = theGameSpeed; };

private:
   static int theGameSpeed; // frames per second
   ...
   static bool  isCPress;            //    "   x            "
   static int  isSpaceHoldDown;      //    " hold down space"
   static bool isSpacePress;         //    "   space        "
   static bool isNavUpPress;         //    "   menu nav up  "
   static bool isNavDownPress;       //    "   menu nav down"
   static bool isEnterPress;         //    "   enter key    "
   static bool isPPress;             //    "   P for pause  "
   static bool isEscPress;           //    "   Esc key      "
};
