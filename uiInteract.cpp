...
int          Interface::isSpaceHoldDown = 0;
bool         Interface::isSpacePress = false;
bool         Interface::isCPress     = false;
bool         Interface::isNavUpPress      = false;
bool         Interface::isNavDownPress    = false;
